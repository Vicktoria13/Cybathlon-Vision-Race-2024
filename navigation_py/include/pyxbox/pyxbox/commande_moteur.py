...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        super().__init__('Commande_Moteur') #Nom du node
        self.xfinal_ = 0.0
        self.yfinal_ = 15.0
        ...
        self.get_direction_subscriber_ = self.create_subscription(Point,'direction',self.call_back_get_direction,10)
        self.get_logger().info("Node Commande_Moteur started")
        
    def call_back_get_direction(self,direction : Point):

        self.xfinal_=direction.x
        self.yfinal_=direction.y
